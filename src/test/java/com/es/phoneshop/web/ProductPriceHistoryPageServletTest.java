...
public class ProductPriceHistoryPageServletTest {
    ...
    public void setup() throws ServletException {
        ...
        servlet = Mockito.spy(new ProductPriceHistoryPageServlet());
    ...
    @Test
    public void testProductDescriptiAndPriceHistoryLoadedOnThePage() throws ServletException, IOException {
        Product product = new ProductBuilder()
                .setCode(TEST_CODE)
                .setDescription(TEST_DESCRIPTION)
                .setPrice(TEST_PRICE)
        ...
        when(productDao.getProduct(any())).thenReturn(product);
        servlet.doGet(request, response);
        verify(request).setAttribute(eq(ATTRIBUTE_PRICE_HISTORY), any());
        verify(request).setAttribute(eq(ATTRIBUTE_DESCRIPTION), any());
    }
}